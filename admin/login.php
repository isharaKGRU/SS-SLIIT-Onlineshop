...
<head>
    ...
    <script type="text/javascript" src="appwrite.js"></script>
    <!-- Main css -->
                ...
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form  class="register-form" id="login-form" action="login.php" method="post">
                            ...
                            <div class="form-group form-button" style="background:color(blue red green blue)">
                               <button onclick="handlelogin()" style="width: 100px; height: 40px; color:deepskyblue">Login with Google </button>
